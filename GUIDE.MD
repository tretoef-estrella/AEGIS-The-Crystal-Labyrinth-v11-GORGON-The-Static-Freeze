...
You need Python 3 installed on your computer. Nothing else.
...
- [STRATEGIES.md](STRATEGIES.md) — How the defense architecture works
- [QUANTUM_VERDICT.md](QUANTUM_VERDICT.md) — Detailed quantum security analysis
- [PAPER.md](PAPER.md) — Full technical paper
- [HISTORY.md](HISTORY.md) — How we got here, from v1 to v16
